# EEIP.NetStandard
> [!NOTE]  
> This project is a community port of the original **EEIP.NET** library [here](https://github.com/rossmann-engineering/EEIP.NET) which
> was created by [Rossman Engineering](https://github.com/rossmann-engineering) under the [MIT License](LICENSE).  
